...
RegsiterResponseListModel regsiterResponseListModelFromJson(String str) => RegsiterResponseListModel.fromJson(json.decode(str));

String regsiterResponseListModelToJson(RegsiterResponseListModel data) => json.encode(data.toJson());
